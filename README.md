...
- **Автообновление**: автоматическая проверка и установка новых версий
...
- **Автообновление**: при запуске проверяется новая версия на GitHub


## Автообновление

При запуске приложение автоматически проверяет наличие новой версии на GitHub.

### Ручная проверка:
- Меню **Инструменты** → **Проверить обновления**

### Как работает:
1. При запуске (через 1 секунду) происходит автопроверка
2. Если найдена новая версия — предлагается загрузить и установить
3. После успешного обновления требуется перезапуск приложения

### Требования:
- Доступ к интернету
- Права на запись в папку с приложением
